...
const EthereumMainNetContracts = {
  // router: {
...
const EthereumMainNetTokenList = [
  // {
  //   icon: ETH,
  //   name: "ETH",
  //   address: "BNB",
...
const EthereumTestNetContracts = {
   // router: {
  //   address: "0xC206bCb31DF33A972b6F52A99C24B5D6b74afdf2",
  //   Block: 6615558,
  //   abi: routerABI,
...
const EthereumTestNetTokenList = {
   // {
  //   icon: ETH,
  //   name: "ETH",
  //   address: "BNB",
...
const constants = (state = EthereumMainNetContracts, action) => {
  switch (action.type) {

    case actionTypes.ETHEREUM_MAINNET_CONTRACTS:
      return {EthereumMainNetContracts};
    case actionTypes.ETHEREUM_MAINNET_TOKENS:
      return {EthereumMainNetTokenList};
 
    case actionTypes.ETHEREUM_TESTNET_CONTRACTS:
      return {EthereumTestNetContracts};
    case actionTypes.ETHEREUM_TESTNET_TOKENS:
      return {EthereumTestNetTokenList};
