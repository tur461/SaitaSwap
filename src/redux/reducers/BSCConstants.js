...
const constants = (state = BSCMainNetContracts, action) => {
  switch (action.type) {

    case actionTypes.BSC_MAINNET_CONTRACTS:
      return {BSCMainNetContracts};
    case actionTypes.BSC_MAINNET_TOKENS:
      return {BSCMainNetTokenList};
      
    case actionTypes.BSC_TESTNET_CONTRACTS:
      return {BSCTestNetContracts};
    case actionTypes.BSC_TESTNET_TOKENS:
      return {BSCTestNetTokenList};
